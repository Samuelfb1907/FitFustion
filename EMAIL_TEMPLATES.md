...
> ⚠️ Die Platzhalter **`{{ .ConfirmationURL }}`** müssen **genau so** stehen bleiben – Supabase setzt dort
> automatisch den persönlichen Link ein. (Absender-Name & -Adresse stellst du separat unter
> *SMTP Settings* ein, nicht hier.)
...
<div style="font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;max-width:480px;margin:0 auto;padding:24px;color:#1A2230;">
  ...
  <p style="text-align:center;margin:24px 0;">
    <a href="{{ .ConfirmationURL }}" style="background:#2B50D8;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:10px;font-weight:700;display:inline-block;">Passwort neu setzen</a>
  </p>
