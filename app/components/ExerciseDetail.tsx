...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    coachBodyClip: { position: 'absolute', top: -105, left: '50%', marginLeft: -105, width: 210, height: 105, overflow: 'hidden', zIndex: 1 },
    ...
    coachImgArms: { position: 'absolute', top: -105, left: 0, width: 210, height: 210 },
