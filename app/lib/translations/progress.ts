// Uebersetzungen fuer ProgressScreen (Namespace: progress).
...
export const de = {
  ...
  'progress.deleteConfirmBody': 'Dieser Gewichtseintrag wird dauerhaft entfernt und verändert deine Verlaufskurve.',
  'progress.cancel': 'Abbrechen',
  'progress.delete': 'Löschen',

  'progress.statSessions': 'Trainings',
  'progress.statSets': 'Sätze gesamt',
  ...
  'progress.shareCardTitle': 'Deine Woche',
  'progress.shareButton': 'Woche teilen',
  'progress.shareBody': 'Meine FitAvo-Woche: {workouts} Trainings, {sets} Sätze, {kg} kg Volumen, {streak} Tage Streak. Trainier mit mir: {url}',
  'progress.shareUrl': 'https://www.fitavo.eu',
  'progress.historyHide': 'Verlauf ausblenden',
...
export const en = {
  ...
  'progress.weightInvalid': 'Please enter a valid weight ({min}–{max} kg).',
  'progress.saveFailed': 'Saving failed: {err}',
  'progress.weightSaved': 'Weight saved ✓',

  'progress.deleteFailedTitle': 'Delete failed',
  'progress.deleteConfirmTitle': 'Delete entry?',
  'progress.deleteConfirmBody': 'This weight entry will be permanently removed and will change your progress curve.',
  'progress.cancel': 'Cancel',
  'progress.delete': 'Delete',

  'progress.statSessions': 'Workouts',
  'progress.statSets': 'Total sets',
  ...
  'progress.delta30': '30 days',
  'progress.deltaSinceStart': 'since start',
  'progress.chartHint': 'Log your weight regularly – from the 2nd entry your curve appears here.',
  'progress.goalProgress': 'Goal progress',
  'progress.goalReached': 'reached 🎉',
  'progress.goalRemaining': '{n} kg to go',
  'progress.weightPlaceholder': 'Today\'s weight (kg)',
  'progress.submit': 'Add',
  'progress.shareCardTitle': 'Your week',
  'progress.shareButton': 'Share week',
  'progress.shareBody': 'My FitAvo week: {workouts} workouts, {sets} sets, {kg} kg volume, {streak}-day streak. Train with me: {url}',
  'progress.shareUrl': 'https://www.fitavo.eu',
  'progress.historyHide': 'Hide history',
