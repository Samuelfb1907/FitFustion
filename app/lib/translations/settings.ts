...
export const de = {
  ...
  'settings.health.alert.neededBody': 'Bitte installiere/aktiviere die „Health Connect"-App (ab Android 14 vorinstalliert) und verbinde dann erneut.',
...
export const en = {
  ...
  'settings.health.alert.neededBody': "Please install/enable the \"Health Connect\" app (pre-installed on Android 14 and up), then connect again.",
