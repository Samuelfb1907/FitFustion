...
export const de = {
  ...
  // "Sprich's einfach" (KI)
  "food.nlTitle": "✍️  Schreib, was du gegessen hast",
  "food.nlConsentHint": "ℹ️ Analyse per KI (Anthropic, USA) – freiwillig, in Einstellungen widerrufbar.",
...
export const en = {
  ...
  // "Just say it" (AI)
  "food.nlTitle": "✍️  Write what you ate",
  "food.nlConsentHint": "ℹ️ AI analysis (Anthropic, USA) – optional, revocable in settings.",
