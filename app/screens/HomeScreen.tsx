...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    macroValue: { fontSize: 16, fontWeight: Platform.OS === 'android' ? '500' : '800', color: c.heading },
    ...
    statValue: { fontSize: 21, fontWeight: Platform.OS === 'android' ? '500' : '800', color: c.heading, marginTop: 14, letterSpacing: -0.3 },
