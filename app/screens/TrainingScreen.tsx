...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    chip: { ...shadow, backgroundColor: c.card, borderRadius: 14, paddingHorizontal: 16, paddingVertical: 11, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border },
    ...
    exRow: { ...shadow, flexDirection: 'row', alignItems: 'center', backgroundColor: c.card, borderRadius: 14, paddingVertical: 16, paddingHorizontal: 16, marginBottom: 10, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border },
