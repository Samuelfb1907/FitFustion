...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    allergyNote: { backgroundColor: c.inputBg, borderRadius: 16, padding: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border, marginBottom: 14 },
    ...
    foodRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: c.card, borderRadius: 16, padding: 14, marginBottom: 8, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border },
