...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    dayOpt: { width: 52, height: 52, borderRadius: 16, borderWidth: 1, borderColor: c.border, alignItems: 'center', justifyContent: 'center', backgroundColor: c.card },
    ...
    secondaryBtn: { borderWidth: 1, borderColor: c.border, backgroundColor: c.card, borderRadius: 14, paddingVertical: 12, alignItems: 'center', marginBottom: 16 },
    ...
    dayCard: { ...shadow, backgroundColor: c.card, borderRadius: 16, padding: 18, marginBottom: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border },
    ...
    weekCard: { ...shadow, backgroundColor: c.card, borderRadius: 16, padding: 18, marginBottom: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border },
    ...
    pickRow: { ...shadow, flexDirection: 'row', alignItems: 'center', backgroundColor: c.card, borderRadius: 16, padding: 14, marginBottom: 8, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border },
    ...
    addExBtn: { marginTop: 10, borderWidth: 1, borderColor: c.primary, borderRadius: 14, paddingVertical: 12, alignItems: 'center', backgroundColor: c.inputBg },
