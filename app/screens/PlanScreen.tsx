...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    dayCard: { ...shadow, backgroundColor: c.card, borderRadius: 16, padding: 18, marginBottom: 12, borderWidth: 1, borderColor: c.cardBorder },
    ...
    weekCard: { ...shadow, backgroundColor: c.card, borderRadius: 16, padding: 18, marginBottom: 16, borderWidth: 1, borderColor: c.cardBorder },
    ...
    pickRow: { ...shadow, flexDirection: 'row', alignItems: 'center', backgroundColor: c.card, borderRadius: 16, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: c.cardBorder },
