...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    dayCard: { ...shadow, backgroundColor: c.card, borderRadius: 22, padding: 18, marginBottom: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border },
    ...
    weekCard: { ...shadow, backgroundColor: c.card, borderRadius: 22, padding: 18, marginBottom: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: c.border },
