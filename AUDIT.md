...
- [ ] **Allergie-Versprechen entschärfen** – Onboarding bietet 39 Allergene, die Rezepte taggen nur 13. „Banane/Apfel/Weizen/Mais/Histamin…" werden trotz Auswahl vorgeschlagen, obwohl der Plan „schließt deine Allergien aus" verspricht. → Mindestens UI-Text auf „berücksichtigt gängige Allergene" ändern (richtiger Fix unter P2). *(lib/meals.ts, NutritionScreen.tsx)*
